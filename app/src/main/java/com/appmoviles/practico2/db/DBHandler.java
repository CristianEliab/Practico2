package com.appmoviles.practico2.db;
...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public static final String AMIGOS_USER_ID = "userid";
    public static final String CREATE_TABLE_AMIGOS = "CREATE TABLE " + TABLE_AMIGOS + " (" + AMIGOS_ID + " TEXT PRIMARY KEY, " + AMIGOS_NOMBRE + " TEXT, " + AMIGOS_EDAD + " TEXT, " + AMIGOS_CORREO + " TEXT, " + AMIGOS_TELEFONO + " TEXT, " + AMIGOS_USER_ID + " TEXT)";
    ...
    public void createAmigo(Amigo amigo) {
        ...
        db.execSQL("INSERT INTO " + TABLE_AMIGOS + " (" + AMIGOS_ID + ", " + AMIGOS_NOMBRE + ", " + AMIGOS_EDAD + ", " + AMIGOS_CORREO + ", " + AMIGOS_TELEFONO + ", " + AMIGOS_USER_ID + ") VALUES ('" + amigo.getId() + "','" + amigo.getNombre() + "','" + amigo.getEdad() + "','" + amigo.getEmail() + "','" + amigo.getTelefono() + "','" + amigo.getUserID() + "')");
        db.close();
    }
    ...
    public ArrayList<Amigo> getAllAmigosOfUser(String uid) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_AMIGOS + " WHERE " + AMIGOS_USER_ID + "='" + uid + "'", null);
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                amigo.setUserID(cursor.getString(cursor.getColumnIndex(AMIGOS_USER_ID)));
                respuesta.add(amigo);
    ...
    public void deleteAmigosOfUser(String uid) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("DELETE FROM " + TABLE_AMIGOS + " WHERE " + AMIGOS_USER_ID + "='" + uid + "'");
        db.close();
    }
}
